    ...
    return (
        ...
        {/* shadow-sm shadow-gray-800 p-3.5 border border-slate-800 */}
            <div className="box-left w-full xl:w-1/5">
                ...
                <h1 className="font-bold tracking-tight inline font-semibold from-[#FF72E1] to-[#F54C7A] text-3xl lg:text-7xl bg-clip-text text-transparent bg-gradient-to-b break-words" >{title}</h1>
